...
public class Question1 {
	public static void main(String[] args){
		...
		case 2:
		{
			...
			String c =mech.displayCourseDetails("Mechanical");
			System.out.println(c);//call the function of the class that you initialized
			break;
		}
		case 3:
		{
			...
			//Initialize the Class using appropriately taking the concept of inheritence and polymorphism in mind.
			CSE cse = new CSE();
			String b = cse.displayCourseDetails("CSE");
			System.out.println(b);//call the function of the class that you initialized
			break;
		}
		default:
